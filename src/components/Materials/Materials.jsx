...
const Materials = () => {
  ...
  const fetchMaterials = async () => {
    try {
      ...
      if (data.success) {
        ...
        setError(
          "Failed to fetch materials: " + (data.message || "Unknown error")
        );
      }
    } catch (err) {
  ...
  const handleCreateMaterial = async () => {
    try {
      ...
      // Close dialog and refresh materials
      ...
      Swal.fire({
        icon: "error",
        title: "Error",
        text: "Failed to create material. Please try again.",
        customClass: {
          container: "swal-z-index-fix",
        },
        didOpen: () => {
          ...
          >
            <Box>
              ...
              <Typography variant="body1" sx={{ opacity: 0.9 }}>
                Create and manage construction materials
              </Typography>
            </Box>
            <Button
              variant="contained"
                    ...
                    >
                      ...
                      <TableCell>
                        <Box display="flex" gap={0.5}>
                          <Tooltip title="View Material Details" arrow>
                            <IconButton
                              size="small"
            ...
            {selectedMaterial && (
              <Box>
                ...
                <Box sx={{ mt: 2 }}>
                  ...
                  <Typography variant="subtitle2" gutterBottom>
                    Unit Cost: ${selectedMaterial.unit_cost}
                  </Typography>
                  <Typography variant="subtitle2" gutterBottom>
                    Quantity Required: {selectedMaterial.quantity_required}
                  </Typography>
                  <Typography variant="subtitle2" gutterBottom>
                    Quantity Used: {selectedMaterial.quantity_used}
                  </Typography>
                  <Typography variant="subtitle2" gutterBottom>
                    Status: {getStatusText(selectedMaterial)}
                  </Typography>
                  <Typography variant="subtitle2" gutterBottom>
                    Task: {selectedMaterial.task?.name || "N/A"}
                  </Typography>
                  <Typography variant="subtitle2" gutterBottom>
                    Project: {selectedMaterial.task?.project?.name || "N/A"}
                  </Typography>
                </Box>
              </Box>
            )}
        ...
        >
          ...
          >
            <Stack spacing={3} sx={{ mt: 1 }}>
              ...
              {/* Quantity Required and Used Row */}
              <Box
                display="flex"
                flexDirection={{ xs: "column", sm: "row" }}
                gap={2}
              >
                ...
                <TextField
                  ...
                  onChange={(e) =>
                    setEditForm({ ...editForm, quantity_used: e.target.value })
                  }
                  variant="outlined"
                  size="small"
                />
            ...
            <Stack spacing={3} sx={{ mt: 1 }}>
              ...
              >
                ...
                <TextField
                  ...
                  onChange={(e) =>
                    setCreateForm({ ...createForm, unit_cost: e.target.value })
                  }
                  variant="outlined"
                  size="small"
                  required
              ...
              >
                <TextField
                  ...
                  label="Quantity Required"
                  type="number"
                  value={createForm.quantity_required}
                  onChange={(e) =>
                    setCreateForm({
                      ...createForm,
                      quantity_required: e.target.value,
                ...
                <TextField
                  ...
                  label="Quantity Used"
                  type="number"
                  value={createForm.quantity_used}
                  onChange={(e) =>
                    setCreateForm({
                      ...createForm,
